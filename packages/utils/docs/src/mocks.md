...
| ------ | ------ | ------ | ------ | ------ |
| <a id="message"></a> `MESSAGE` | `readonly` | `"message"` | Emitted when a new message arrives on the message queue. | src/mocks.ts:47 |

***

### FakeDatabaseClient

Defined in: src/mocks.ts:97
...
| Event | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="ready"></a> `READY` | `readonly` | `"ready"` | Emitted once the client connects to the database. | src/mocks.ts:103 |
